...
print("\n======================================================\n")
print("You drove your {make} {model} {m} miles and used {g} gallons of fuel.".format(make=vehicleMake, model=vehicleModel, m=miles, g=gallons))
print("Your fuel economy was {e:1.1f} MPG".format(e=efficiency))
print("Drive safely.\n")
